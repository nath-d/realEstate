    ...
    useEffect(() => {
        const fetchReviews = async () => {
            try {
                ...
                setReviewsSource('Static Fallback');
            } finally {
                setLoading(false);
            }
        };
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    ...
                    <div className="flex justify-center items-center gap-4">
                        ...
                        <p className="text-[#122620]/80">
                            {reviewsSource === 'Google Places API' ? 'Real Google Reviews' : 'What our clients say about us'}
                        </p>
                        <motion.span
                            initial={{ width: 0 }}
                            whileInView={{ width: 120 }}
                    ...
                    {reviewsSource && (
                        <p className="text-sm text-[#122620]/60 mt-2">
                ...
                {loading && (
                    <div className="text-center mb-20">
                        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#D6AD60] mx-auto"></div>
                        <p className="text-[#122620]/60 mt-4">Loading reviews...</p>
                    </div>
                )}
