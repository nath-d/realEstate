...
//         <section
//             ref={sectionRef}
//             className="py-32 bg-gradient-to-b from-[#122620] to-[#0a1a17] relative overflow-hidden"
//         >
//             {/* Brand Watermark */}
...
//                         <div className="absolute inset-x-0 top-1/2 transform -translate-y-1/2 h-3 bg-gradient-to-r from-[#D6AD60] via-transparent to-[#B38C3D] opacity-30"></div>
//                         <h2 className="text-5xl md:text-6xl lg:text-7xl font-source-serif text-[#F4EBD0] relative z-10">
//                             <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#D6AD60] to-[#B38C3D]">Why Choose ProjectEstate?</span>
//                         </h2>
//                     </div>
//                     <p className="text-[#F4EBD0]/90 font-montserrat text-xl max-w-3xl mx-auto leading-relaxed">
...
//                 {/* Image Banner */}
//                 <motion.div
//                     className="relative h-[400px] rounded-2xl overflow-hidden mb-24 shadow-2xl"
//                     initial={{ opacity: 0, y: 20 }}
//                     animate={controls}
//                     variants={{ visible: { opacity: 1, y: 0, transition: { duration: 0.8, delay: 0.2, ease: [0.22, 1, 0.36, 1] } } }}
//                 >
//                     <img
//                         src={image}
//                         alt={alt}
...
//                         <div className="text-center px-8 rounded-xl p-6 bg-black bg-opacity-40">
//                             <h3 className="text-3xl md:text-4xl font-source-serif text-[#F4EBD0] mb-2">Your Luxury Real Estate Partner</h3>
//                             <p className="text-[#F4EBD0]/90 text-lg md:text-xl max-w-2xl mx-auto">
//                                 Where extraordinary listings meet unmatched expertise
//                             </p>
//                         </div>
//                     </div>
//                 </motion.div>
...
//                         >
//                             <div className="bg-[#F4EBD0]/10 backdrop-blur-sm border border-[#D6AD60]/30 rounded-2xl p-8 h-full transform-gpu transition-all duration-500 hover:-translate-y-2 hover:scale-105 hover:bg-[#F4EBD0]/20 hover:border-[#B38C3D] hover:shadow-2xl hover:shadow-[#D6AD60]/20">
//                                 <div className="w-16 h-16 rounded-lg bg-gradient-to-br from-[#D6AD60]/20 to-[#B38C3D]/20 flex items-center justify-center text-[#D6AD60] mb-6 group-hover:scale-110 transition-transform duration-500">
//                                     {reason.icon}
//                                 </div>
//                                 <h3 className="text-2xl font-source-serif text-transparent bg-clip-text bg-gradient-to-r from-[#D6AD60] to-[#B38C3D] mb-4">{reason.title}</h3>
//                                 <p className="text-[#F4EBD0]/70 font-montserrat text-base leading-relaxed mb-6">{reason.description}</p>
//                                 <div className="flex items-baseline space-x-2">
//                                     <span className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#D6AD60] to-[#B38C3D]">{reason.stat}</span>
//                                     <span className="text-[#F4EBD0]/60 text-sm uppercase tracking-wide">{reason.statText}</span>
//                                 </div>
//                             </div>
//                         </motion.div>
//                     ))}
            ...
            <div className="py-4 px-4 mx-auto max-w-screen-xl sm:py-8 lg:px-6">
                ...
                >
                    ...
                    <motion.div 
                        ...
                        variants={{ visible: { opacity: 1, y: 0, transition: { duration: 0.8, ease: [0.22, 1, 0.36, 1] } }, hidden: { opacity: 0, y: 20 } }}
                    >
                        <div className="group relative flex flex-col overflow-hidden rounded-xl px-6 pb-8 pt-40 h-full bg-white shadow-md hover:shadow-xl transition-shadow duration-300">
                            <img 
                                src={reasons[0].bgImg} 
                                alt={reasons[0].title} 
                            ...
                            <div className="z-10 flex flex-col h-full justify-end">
                                <div className="mt-auto">
                                    <div className="flex items-center mb-4">
                                        <div className="w-12 h-12 rounded-lg bg-white/20 backdrop-blur-sm flex items-center justify-center text-white mr-4">
                                            {reasons[0].icon}
                                        </div>
                                        <h3 className="text-3xl font-medium text-white">{reasons[0].title}</h3>
                                    </div>
                                    <p className="text-white/90 text-lg mb-6">{reasons[0].description}</p>
                                    <div className="flex items-baseline space-x-2">
                                        <span className="text-4xl font-bold text-[#D6AD60]">{reasons[0].stat}</span>
                                        <span className="text-white/80 text-sm uppercase tracking-wide">{reasons[0].statText}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="z-10 flex flex-col h-full justify-end">
                                <div className="mt-auto">
                                    <div className="flex items-center mb-3">
                                        <div className="w-10 h-10 rounded-lg bg-white/20 backdrop-blur-sm flex items-center justify-center text-white mr-3">
                                            {reasons[1].icon}
                                        </div>
                                        <h3 className="text-2xl font-medium text-white">{reasons[1].title}</h3>
                                    </div>
                                    <p className="text-white/90 text-base mb-4">{reasons[1].description}</p>
                                    <div className="flex items-baseline space-x-2">
                                        <span className="text-3xl font-bold text-[#D6AD60]">{reasons[1].stat}</span>
                                        <span className="text-white/80 text-sm uppercase tracking-wide">{reasons[1].statText}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    >
                        <div className="grid grid-cols-2 gap-6 h-full">
                            {[2, 3].map(index => (
                                <div key={reasons[index].id} className="group relative flex flex-col overflow-hidden rounded-xl px-4 pb-6 pt-36 bg-white shadow-md hover:shadow-xl transition-shadow duration-300">
                                    <img 
                                    ...
                                    <div className="z-10 flex flex-col h-full justify-end">
                                        <div className="mt-auto">
                                            <div className="flex items-center mb-2">
                                                <div className="w-8 h-8 rounded-lg bg-white/20 backdrop-blur-sm flex items-center justify-center text-white mr-2">
                                                    {reasons[index].icon}
                                                </div>
                                                <h3 className="text-xl font-medium text-white">{reasons[index].title}</h3>
                                            </div>
                                            <p className="text-white/90 text-sm mb-3 line-clamp-2">{reasons[index].description}</p>
                                            <div className="flex items-baseline space-x-2">
                                                <span className="text-2xl font-bold text-[#D6AD60]">{reasons[index].stat}</span>
                                                <span className="text-white/80 text-xs uppercase tracking-wide">{reasons[index].statText}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <motion.div 
                        ...
                        variants={{ visible: { opacity: 1, y: 0, transition: { duration: 0.8, ease: [0.22, 1, 0.36, 1] } }, hidden: { opacity: 0, y: 20 } }}
                    >
                        <div className="group relative flex flex-col overflow-hidden rounded-xl px-4 pb-6 pt-36 h-full bg-white shadow-md hover:shadow-xl transition-shadow duration-300">
                            <img 
                                src={reasons[4].bgImg} 
                                alt={reasons[4].title} 
                                className="absolute inset-0 h-full w-full object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out"
                            ...
                            <div className="z-10 flex flex-col h-full justify-end">
                                <div className="mt-auto">
                                    <div className="flex items-center mb-2">
                                        ...
                                        <h3 className="text-xl font-medium text-white">{reasons[4].title}</h3>
                                    </div>
                                    <p className="text-white/90 text-sm mb-3 line-clamp-3">{reasons[4].description}</p>
                                    <div className="flex items-baseline space-x-2">
                                        <span className="text-2xl font-bold text-[#D6AD60]">{reasons[4].stat}</span>
                                        <span className="text-white/80 text-xs uppercase tracking-wide">{reasons[4].statText}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="z-10 flex flex-col h-full justify-end">
                                <div className="mt-auto">
                                    <div className="flex items-center mb-3">
                                        ...
                                        <h3 className="text-2xl font-medium text-white">{reasons[5].title}</h3>
                                    </div>
                                    <p className="text-white/90 text-base mb-4">{reasons[5].description}</p>
                                    <div className="flex items-baseline space-x-2">
                                        <span className="text-3xl font-bold text-[#D6AD60]">{reasons[5].stat}</span>
                                        <span className="text-white/80 text-sm uppercase tracking-wide">{reasons[5].statText}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                >
                    ...
                    <a
                        href="/contact"
                        className="inline-block bg-gradient-to-r from-[#D6AD60] to-[#B38C3D] text-gray-900 font-sans font-semibold px-10 py-4 rounded-full hover:from-[#F4EBD0] hover:to-[#D6AD60] transition-all duration-500 transform hover:scale-105 shadow-lg hover:shadow-xl text-lg"
                    >
                        Schedule Your Private Consultation
                    </a>
                </motion.div>
